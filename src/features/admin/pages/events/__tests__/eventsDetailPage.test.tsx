...
vi.mock('@/features/admin/hooks/eventsHooks', () => ({
  ...
  useEvent: () => ({ data: { data: { id: '1', name: 'Test Event' } }, isLoading: false, error: null }),
}));
...
describe('EventsDetailPage', () => {
  ...
  it('shows delete confirmation dialog when delete button is clicked', async () => {
    ...
    await waitFor(() => {
      expect(screen.getByText(/Êtes-vous sûr de vouloir supprimer cet événement/i)).toBeInTheDocument();
    });
  });
